...
public class ConnectionPool {
	...
	static {
		ResourceBundle bundle = PropertyResourceBundle.getBundle("oodb.ConnectionPool");
		...
		try {
			connectionPool = new ConnectionPool(jdbcURL, username, password, preconnectCount, maxIdleConnections,
					maxConnections);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
